...
function Home() {
  ...
  const baseAPI = "https://company-website-5l9u.onrender.com";
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.post(`${baseAPI}/api/contact`, form, {
        ...
        <div className="nav-left">
          ...
          <div className="services">
            ...
            <div className="dropdown-menu">
              ...
              <div className="service-card">Software Testing</div>
              <div className="service-card">Social Media Marketing</div>
              <div className="service-card">SEO Specialist</div>
              <div className="service-card">Photography</div>
              <div className="service-card">Videography</div>
              {/* <div className="service-card">Social Media Handling</div> */}
              <div className="service-card">Embedded</div>
              <div className="service-card">Internet Of Things</div>
            </div>
          </div>
        </div>
        ...
        <div className="career-carousel">
          ...
          <div className="career-track">
            ...
            <div className="career-card">
              ...
              <button className="career-btn" onClick={() => navigate("/fullstack")}>
                Click Here
              </button>
            </div>
            <div className="career-card">
              ...
              <button
                ...
                onClick={() => navigate("/seo")} // ✅ Navigate to Seo.jsx
              >
                Click Here
              </button>
            </div>
            ...
            <div className="career-card">
              ...
              <button
                className="career-btn"
                onClick={() => navigate("/datascientist")}
              >
                Click Here
              </button>
            </div>
            ...
            <div className="career-card">
              ...
              <button
                className="career-btn"
                onClick={() => navigate ( "/cloudengineer")}
              >
                Click Here
              </button>
            </div>
          ...
          <div className="contact-info">
            ...
            <div className="info-block">
              ...
              <p>
                ...
                <a href="tel:+919940847940 tel:+91 7708921550">+91 9940847940,+91 7708921550<br></br></a>
